...
const ::PROTOBUF_NAMESPACE_ID::uint32 TableStruct_user_2eproto::offsets[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  ...
  ~0u,  // no _oneof_case_
  ~0u,  // no _weak_field_map_
  PROTOBUF_FIELD_OFFSET(::fixbug::RegisterResponse, code_),
...
const char descriptor_table_protodef_user_2eproto[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) =
  ...
  "RegisterResponse\022 \n\004code\030\001 \001(\0132\022.fixbug."
  ...
  "g.RegisterRequest\032\025.fixbug.LoginResponse"
...
void RegisterResponse::InitAsDefaultInstance() {
  ::fixbug::_RegisterResponse_default_instance_._instance.get_mutable()->code_ = const_cast< ::fixbug::ResultCode*>(
      ::fixbug::ResultCode::internal_default_instance());
}
class RegisterResponse::_Internal {
 public:
  static const ::fixbug::ResultCode& code(const RegisterResponse* msg);
};
