...
const ::PROTOBUF_NAMESPACE_ID::uint32 TableStruct_friend_2eproto::offsets[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  ...
  PROTOBUF_FIELD_OFFSET(::RPC::GetFriendlistResponse, friendlist_),
};
...
const char descriptor_table_protodef_friend_2eproto[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) =
  ...
  "Code\022\022\n\nfriendlist\030\002 \003(\0142Z\n\020FriendServic"
  "eRpc\022F\n\rGetFriendlist\022\031.RPC.GetFriendlis"
  "tRequest\032\032.RPC.GetFriendlistResponseB\003\200\001"
  "\001b\006proto3"
  ;
...
const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable descriptor_table_friend_2eproto = {
  false, false, descriptor_table_protodef_friend_2eproto, "friend.proto", 289,
